...
STIFFNESS_HIP_PITCH = ARMATURE_FOR_PD_HIP_PITCH * NATURAL_FREQ**2
STIFFNESS_HIP_ROLL = ARMATURE_FOR_PD_HIP_ROLL * NATURAL_FREQ**2
STIFFNESS_HIP_YAW = ARMATURE_FOR_PD_HIP_YAW * NATURAL_FREQ**2
STIFFNESS_KNEE = ARMATURE_FOR_PD_KNEE * NATURAL_FREQ**2
STIFFNESS_ANKLE_PITCH = ARMATURE_FOR_PD_ANKLE_PITCH * NATURAL_FREQ**2
STIFFNESS_ANKLE_ROLL = ARMATURE_FOR_PD_ANKLE_ROLL * NATURAL_FREQ**2
...
DAMPING_HIP_PITCH = 2.0 * DAMPING_RATIO * ARMATURE_FOR_PD_HIP_PITCH * NATURAL_FREQ
...
DAMPING_KNEE = 2.0 * DAMPING_RATIO * ARMATURE_FOR_PD_KNEE * NATURAL_FREQ
DAMPING_ANKLE_PITCH = 2.0 * DAMPING_RATIO * ARMATURE_FOR_PD_ANKLE_PITCH * NATURAL_FREQ
DAMPING_ANKLE_ROLL = 2.0 * DAMPING_RATIO * ARMATURE_FOR_PD_ANKLE_ROLL * NATURAL_FREQ
